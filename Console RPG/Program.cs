...
namespace Console_RPG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Location.midNowhere8.SetNearbyLocations(west: Location.midNowhere3, east: Location.midNowhere6, south: Location.shopPlace);
            Location.theGrave.SetNearbyLocations(south: Location.midNowhere7);
            Location.theHall.SetNearbyLocations(west: Location.midNowhere4, east: Location.theEnd);
